      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 grid-rows-[auto_1fr] gap-y-16 pt-16 md:pt-20 lg:grid-cols-12 lg:gap-y-20 lg:px-3 lg:pb-36 lg:pt-20 xl:py-32">
        <div className="relative flex items-end lg:col-span-5 lg:row-span-2">
          ...
          <div className="relative z-10 mx-auto flex w-64 rounded-xl bg-slate-600 shadow-xl md:w-80 lg:w-auto">
            <Image src={coverImage} alt="" priority height="1500px"/>
          </div>
        </div>
          ...
          <figure className="relative mx-auto max-w-md text-center lg:mx-0 lg:text-left">
            ...
            <blockquote className="mt-2">
              <p className="font-display text-xl font-medium text-slate-900">
                “As I always say there is not better time to eat any cream,
                I mean ice-cream :)”
              </p>
            </blockquote>
        ...
        <div className="bg-white pt-16 lg:col-span-7 lg:bg-transparent lg:pt-0 lg:pl-16 xl:pl-20">
          <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
            <h1 className="font-display text-5xl font-extrabold text-slate-900 sm:text-6xl">
              Make your own Ice cream like the way you dream.
            </h1>
            <p className="mt-4 text-3xl text-slate-600">
							Helado allows you to make your own ice cream the way you like and deliver directly to your House :)
            </p>
